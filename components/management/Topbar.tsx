...
export default function Topbar({ branchName, currentBranchId, role, availableBranches = [] }: TopbarProps) {
                    ...
                    {branchName && (
                        <div className="relative" ref={dropdownRef}>
                            ...
                            {isBranchOpen && availableBranches.length > 1 && (
                                <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
